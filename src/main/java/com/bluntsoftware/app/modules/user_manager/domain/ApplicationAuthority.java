...
public class ApplicationAuthority implements CustomDomain<ApplicationAuthority> {
    ...
    public Class<?> getClassType() {
        return ApplicationAuthority.class;
    }
    ...
    public int compareTo(ApplicationAuthority applicationAuthority) {
        return 0;
    }

    @Override
    public Object clone() throws CloneNotSupportedException {
        ApplicationAuthority entity = (ApplicationAuthority)super.clone();
        entity.setId(null);
        return entity;
    }
}